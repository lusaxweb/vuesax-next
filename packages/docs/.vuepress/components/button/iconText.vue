<template>
  <div class="center">
    ...
    <vs-button color="success" flat :active="active == 1" @click="active = 1">
      <i class="bx bxs-phone-call"></i> Call
    </vs-button>
    <vs-button color="danger" border :active="active == 2" @click="active = 2">
      <i class="bx bxs-heart"></i> Like
    </vs-button>
    <vs-button color="warn" gradient :active="active == 3" @click="active = 3">
